...
On platforms with AES acceleration, [AEGIS](https://www.rfc-editor.org/rfc/rfc10032.html) (available in the standard library as `std.crypto.aead.aegis.Aegis128L`) and [ROCCA](https://github.com/jedisct1/zig-rocca) have higher performance.
